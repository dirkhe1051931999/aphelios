...
import echarts from 'src2/utils/echarts';
import mapJson from 'src2/pages/data/china.json';
@Component({ name: 'myChinaMapChartComponent' })
export default class myChinaMapChartComponent extends Vue {
  public planePath: string =
