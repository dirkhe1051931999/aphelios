...
import Koa from 'koa';
import { addCategory, addVideo, batchAddVideo, batchDelteVideo, deleteCategory, deleteVideo, getAllVideo, queryCategory, updateVideo } from 'src/controllers/management/blog/post.video_lib.controller';
